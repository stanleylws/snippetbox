...
func (app *application) accountView(w http.ResponseWriter, r *http.Request) {
	id := app.getAuthenticatedUserId(r)
	user, err := app.users.Get(id)
	if err != nil {
		app.errorLog.Output(1, err.Error())
...
func (app *application) passwordUpdateView(w http.ResponseWriter, r *http.Request) {
	data := app.newTemplateData(r)
...
func (app *application) userLoginPost(w http.ResponseWriter, r *http.Request) {
	...
	visitingPath := app.sessionManager.PopString(r.Context(), "redirectPathAfterLogin")

	if visitingPath != "" {
		destination = visitingPath
	} else {
		destination = "/snippet/create"
	}
